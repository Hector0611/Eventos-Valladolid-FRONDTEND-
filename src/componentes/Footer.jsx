                ...
                <div className="footer-section Titulo">
                    ...
                    <div className="social-links Titulo">
                        ...
                        <span style={{ display: 'inline-block', width: '20px' }} />
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="Facebook" viewBox="0 0 16 16">
                        ...
                        <span style={{ display: 'inline-block', width: '20px' }} />
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="Instagram" viewBox="0 0 16 16">
                        ...
                        <a href="https://www.youtube.com/channel/UC6XMBvFAR4mRgJE_oqQ1iDA" target="_blank" rel="noopener noreferrer">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" fill="currentColor" className="Youtube" viewBox="0 0 16 16">
